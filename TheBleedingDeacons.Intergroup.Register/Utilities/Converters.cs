...
/// <summary>
/// Returns Gray400 when the group has no GSR members, or Gray900 when it has at least one.
/// Bind to Group.Members (ICollection&lt;Member&gt;).
/// </summary>
public class HasGsrToColorConverter : IValueConverter
{
	public object? Convert(object? value, Type targetType, object? parameter, CultureInfo culture)
	{
		...
		{
			bool hasGsr = members.Any(m => m.IsGsr);
			return hasGsr
				? Application.Current!.Resources["Gray900"]
				: Application.Current!.Resources["Gray400"];
		}

		// No members at all → gray
