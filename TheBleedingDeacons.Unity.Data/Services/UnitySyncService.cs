...
public class UnitySyncService
{
    ...
    public record SyncResult(int Groups, int Meetings, int Positions, int Members, int IntergroupMeetings);
    ...
    public async Task<SyncResult> SyncAsync(CancellationToken ct = default)
    {
        ...
        return new SyncResult(groups.Count, meetings.Count, positions.Count, members.Count, intergroupMeetings.Count);
    }
